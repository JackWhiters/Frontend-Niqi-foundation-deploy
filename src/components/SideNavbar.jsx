    ...
    <>
      <section className="relative flex gap-10 py-0 m-0 max-md:flex-col">
        <div className="sticky top-[80px] z-20">
          ...
          <div
            className={
              "sm:min-w-[200px] h-[calc(100vh-80px-60px)] md:h-cover md:sticky top-24 overflow-y-auto p-6 md:pr-0 md:border-grey md:border-r absolute max-md:top-[64px] bg-white max-md:w-full duration-500 " +
              (!showSideNav ? "max-md:opacity-0 max-md:pointer-events-none" : "opacity-100 pointer-events-auto")
            }
          >
            ...
            >
              <i className="fa fa-rr-document"></i>
              Blogs
            </NavLink>
            ...
            {/* {isAdmin ? (
              <NavLink
                ...
                className="sidebar-link"
              >
                <i className="fa fa-rr-file-edit"></i>
                Write
              </NavLink>
            ) : (
              ""
