...
const NotificationCard = ({ data, index, notificationState }) => {
  ...
  let {
    userAuth: { username: author_username, profile_img: author_profile_img, access_token },
    ...
    <div className={"p-6 border-b border-grey border-l-black " + (!seen ? "border-l-2" : "")}>
        ...
        <div className="w-full">
          <h1 className="font-medium text-xl text-dark-grey">
            ...
            <span className="font-normal">
              {type === "like" ? "menyukai artikelmu" : type === "comment" ? "berkomentar pada" : "membalas pada"}
            </span>
          </h1>
      ...
      {reply ? (
        <div className="ml-20 p-5 bg-grey mt-5 rounded-md">
          <div className="flex gap-3 mb-3">
            ...
            <div>
              <h1 className="font-medium text-xl text-dark-grey">
                ...
                <span className="font-normal">membalas ke</span>
          ...
          <p className="ml-1 font-gelasio text-xl">{reply.comment}</p>

          <button
            className="underline hover:text-black ml-144 mt-2"
