...
import { ManageDraftBlogPost, ManagePublishedBlogCard } from "../components/ManageBlogCard";
...
const ManageBlogs = () => {
  ...
  return (
    <>
      <h1 className="max-md:hidden">Manajemen Artikel</h1>
      ...
      <InPageNavigation
        routes={["Published Artikel", "Drafts"]}
      ...
      >
        {blogs == null ? (
          ...
          <NoDataMessage message="Tidak ada Artikel dipublish" />
        )}
        ...
        {drafts == null ? (
          ...
          <NoDataMessage message="Tidak ada Artikel draft" />
        )}
      </InPageNavigation>
    </>
  );
